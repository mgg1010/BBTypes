...
function getGlobalEditorSettings(): BBSettingDefinition[] {
    return [
        ...
        { id: 'Editor.ControlMinWidth', name: 'Control Min Width', typeId: 'Number', description: 'Calculated minimum width in pixels', defaultValue: 0, readOnly: true, inputOutput: 1 },
        { id: 'Editor.ControlMaxWidth', name: 'Control Max Width', typeId: 'Number', description: 'Calculated maximum width in pixels', defaultValue: 1000, readOnly: true, inputOutput: 1 }
    ];
}
    ...
    // --- Primitives / Core Types ---
    {
        ...
        editors: [{
            ...
            publishedSettings: {
                ...
                'String.MaxLength': 'published',
                'String.MaxLengthMsg': 'published',
                'String.MinLength': 'published',
                'String.MinLengthMsg': 'published',
